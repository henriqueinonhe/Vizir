...
export default {
  ...
  checkPropertiesCompliance(requiredProperties : Array<PropertyKeyTypePair>, object : Record<string, unknown>) : void
  {
    ...
    for(const requiredProperty of requiredProperties)
    {
      ...
      //Array and null require special treament, 
      //because typeof array or null is "object"
      const objectProperty = object[key];
      const objectPropertyType = Array.isArray(objectProperty) ? "array" :  objectProperty === null ? "null" : typeof objectProperty;
