...
describe("constructor", () =>
{
  describe("Pre Conditions", () =>
  {
    describe("Every valid code must be present as a row", () =>
    {
      ...
      {
        const tableData = new Map<number, Map<number, Dinero.Dinero>>();
  
        tableData.set(1, new Map<number, Dinero.Dinero>());
        ...
        tableData.set(2, new Map<number, Dinero.Dinero>());
      ...
      test("Multiple dial codes missing from different rows", () =>
      {
        ...
        tableData.set(3, new Map<number, Dinero.Dinero>());
        ...
        tableData.set(4, new Map<number, Dinero.Dinero>());
...
describe("getRate()", () =>
{
  ...
  tableData.set(11, new Map<number, Dinero.Dinero>());
  ...
  tableData.set(16, new Map<number, Dinero.Dinero>());
  tableData.get(16)!.set(11, DineroReal(290e2));
  tableData.get(16)!.set(16, DineroReal(0));
  tableData.get(16)!.set(17, DineroReal(0));
  tableData.get(16)!.set(18, DineroReal(0));

  tableData.set(17, new Map<number, Dinero.Dinero>());
  tableData.get(17)!.set(11, DineroReal(270e2));
  tableData.get(17)!.set(16, DineroReal(0));
  tableData.get(17)!.set(17, DineroReal(0));
  tableData.get(17)!.set(18, DineroReal(0));

  tableData.set(18, new Map<number, Dinero.Dinero>());
  tableData.get(18)!.set(11, DineroReal(190e2));
  tableData.get(18)!.set(16, DineroReal(0));
  tableData.get(18)!.set(17, DineroReal(0));
  tableData.get(18)!.set(18, DineroReal(0));
  ...
  describe("Post Conditions", () =>
  {
    test("Happy path", () =>
    {
      expect(table.getRate(11, 16).equalsTo(DineroReal(190e2))).toBe(true);
      expect(table.getRate(16, 11).equalsTo(DineroReal(290e2))).toBe(true);
      expect(table.getRate(11, 17).equalsTo(DineroReal(170e2))).toBe(true);
      expect(table.getRate(17, 11).equalsTo(DineroReal(270e2))).toBe(true);
      expect(table.getRate(11, 18).equalsTo(DineroReal(90e2))).toBe(true);
      expect(table.getRate(18, 11).equalsTo(DineroReal(190e2))).toBe(true);
    });
  });
});